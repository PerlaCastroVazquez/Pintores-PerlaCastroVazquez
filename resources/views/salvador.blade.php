...
<h1> {{$header}} </h1>
 ...
 <table>
<tr>
  <td class="table-active"><img src="/images/oned.jpg" class="img-thumbnail"></td> 
  <td class="table-success"><img src="/images/twod.jpg" class="img-thumbnail"></td>
  <td class="table-warning"><img src="/images/threed.jpg" class="img-thumbnail"></td>
  <td class="table-info"><img src="/images/fourd.jpg" class="img-thumbnail"></td>
  
</tr>
</table>
<br>
<h4>«El verdadero pintor es aquel que es capaz de pintar escenas extraordinarias en medio de un desierto vacío.»</h4>
<p class="text-left">
...
<br> Dalí que se calificaba a sí mismo de “caníbal”, “megalomaníaco” y de “perverso polimorfo” muere en Barcelona (España) en 1989.</p>
    @stop
